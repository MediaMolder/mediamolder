> **⚠️ Superseded**: This is the v1.0 specification draft. The current specification is [spec_v3.md](spec_v3.md) (Version 2.0).

**MediaMolder: Project Specification**  
**Version:** 1.0 (Draft) — SUPERSEDED by [v2.0](spec_v3.md)  
