...
![MediaMolder User Interface](images/ABR_x264.png)
...
- **Enable easy migration from the FFmpeg CLI** with a robust FFmpeg command to MediaMolder JSON converter and detailed migration guide (see [FFmpeg Migration Guide](ffmpeg-migration-guide.md)).
